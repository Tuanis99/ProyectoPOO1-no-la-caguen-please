 ...
 */
public class ConsultaReservasEstudiante extends javax.swing.JFrame {

    /**
     * Creates new form ConsultaReservasEstudiante
     */
    public ConsultaReservasEstudiante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaReservasEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaReservasEstudiante().setVisible(true);
            }
        });
    }
